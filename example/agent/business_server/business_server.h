...
#define POSITION_PACKAGE_SIZE REQUEST_HEADER_SIZE+KP_POSITION_CITYID_SIZE
    ...
    返回值:
        ...
        其它 失败
    =========================================================*/
    extern int cnv_init_otherservice(char *strConfPath, CNV_UNBLOCKING_QUEUE  *queueConfig);
    ...
    返回值:
        ...
        其它 失败
    =========================================================*/
    extern int otherservice_init_path(char *strConfPath);
    ...
    返回值:
        ...
        其它 失败
    =========================================================*/
    extern int otherservice_init_config();
